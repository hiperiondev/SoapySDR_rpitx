...
clean-librpitx-2f-src:
	-$(RM) ./librpitx/src/dma.d ./librpitx/src/dma.o ./librpitx/src/dsp.d ./librpitx/src/dsp.o ./librpitx/src/gpio.d ./librpitx/src/gpio.o ./librpitx/src/mailbox.d ./librpitx/src/mailbox.o ./librpitx/src/raspberry_pi_revision.d ./librpitx/src/raspberry_pi_revision.o ./librpitx/src/rpi.d ./librpitx/src/rpi.o ./librpitx/src/util.d ./librpitx/src/util.o
